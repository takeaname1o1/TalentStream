  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
            "group fixed inset-y-0 z-40 hidden md:flex text-sidebar-foreground transition-[width] duration-200 ease-in-out",
        ...
        data-side={side}
        onMouseEnter={isIconCollapsible && state === 'collapsed' ? () => setOpen(true) : undefined}
        onMouseLeave={isIconCollapsible && state === 'expanded' ? () => setOpen(false) : undefined}
        {...props}
      >
        <div
            data-sidebar="sidebar"
